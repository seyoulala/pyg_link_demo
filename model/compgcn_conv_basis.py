...
class CompGCNConvBasis(MessagePassing):
    def __init__(self, in_channels, out_channels, num_rels, num_bases, act=lambda x: x, cache=False, params=None):
        super(CompGCNConvBasis, self).__init__(aggr='add')
