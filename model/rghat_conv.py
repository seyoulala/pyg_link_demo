...
class RGHATConv(MessagePassing):
    def __init__(self, in_channel, out_channel,heads, num_rels,dropout= 0.1,bias=True,
        ...
        self.w1 = nn.Parameter(th.Tensor(self.heads,self.out_channel*2,self.out_channel))
        self.w2 = nn.Parameter(th.Tensor(self.heads,self.out_channel*2,self.out_channel))

        self.w3 = nn.Parameter(th.Tensor(self.heads,self.out_channel,self.out_channel))
        self.w4 = nn.Parameter(th.Tensor(self.heads,self.out_channel,self.out_channel))
